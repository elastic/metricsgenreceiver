...
https://github.com/open-telemetry/opentelemetry-collector-releases/releases/download/cmd%2Fbuilder%2Fv0.158.0/ocb_0.158.0_darwin_arm64
chmod +x ocb
```

Be aware, currently this exact version is needed (v0.158.0).
